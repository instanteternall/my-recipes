...
import { getIngredientById, updateIngredient, getIngredientCategories } from '@/api/ingredients'
...
const loadIngredient = async () => {
  ...
  try {
    ...
    form.expiryDate = ingredient.expiryDate || ''
    form.categoryId = ingredient.categoryId
  } catch (error) {
    console.error(error)
  } finally {
    loading.value = false
